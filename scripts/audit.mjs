...
assert(meals.ingredients.length === 134 && meals.ingredients.filter((item) => item.visible).length === 131 && meals.recipes.length === 163, 'Meal Builder active counts are incorrect');
