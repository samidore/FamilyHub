...
- Meal Builder reads the indexed YAML data under `src/data/meal-builder/`; it has 132 Ingredients, 129 visible Starter choices, and 162 candidate Recipes, including 23 vegetable-centered structures and seven controlled leafy-vegetable add-ons. `docs/archive/FAMILY_MEAL_KB.dump.md` is a historical GPT dump and is not a build source.
