...
Family Hub is a mobile-first reference site for recurring family decisions that benefit from structured lists, search, filtering, and comparison. The first foundation release contains Day Trips, Library Activities, and Pediatric Dentists. Future public modules may include play ideas and recipes; private calendars, appointments, and personal notes require a separately authenticated system.
...
- The home groups and searches the three working modules.
- Exactly 29 trips, 18 library activities, and 10 pediatric dentists are preserved.
