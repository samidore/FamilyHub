...
- Meal Builder reads the indexed YAML data under `src/data/meal-builder/`; it has 134 Ingredients, 131 visible Starter choices, and 163 candidate Recipes, including 23 vegetable-centered structures, 23 checkout-only easy-braise Ingredients, and 36 iron-pan braise Recipes. `docs/archive/FAMILY_MEAL_KB.dump.md` is a historical GPT dump and is not a build source.
